              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex shrink-0 items-center gap-1'>
                  <span
                    className={cn(
                      'size-2 rounded-full',
                      sectionColorClass(sectionIndex),
                    )}
                  />
                  <Button
                    type='button'
            ...
            <div className='flex-1 divide-y overflow-y-auto px-4 pb-4'>
              <div>
                <FieldRow icon={ClockIcon} label='Status'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm'>
                      {task.completed ? 'Done' : (section?.name ?? 'To do')}
                    </span>
                  </div>
                </FieldRow>
                ...
                <FieldRow icon={CalendarIcon} label='Start date'>
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      startTransition(() =>
                        updateTaskStartDate(task.id, projectId, e.target.value),
                      );
                    }}
                ...
                <FieldRow icon={CalendarIcon} label='Due date'>
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      startTransition(() =>
                        updateTaskDueDate(task.id, projectId, e.target.value),
                      );
                    }}
                    className='border-transparent bg-transparent px-0 shadow-none hover:border-input focus-visible:border-input focus-visible:bg-background'
                  />
                ...
                <FieldRow icon={DollarSignIcon} label='Billable'>
                  <div className='flex items-center gap-2'>
                    ...
                    />
                    <span className='text-sm'>
                      {task.billable ? 'Billable Time' : 'Non-billable Time'}
                    </span>
                  </div>
                </FieldRow>
                    ...
                    <DropdownMenuContent align='start'>
                      {profiles.map((profile) => (
                        <DropdownMenuCheckboxItem
                          ...
                          onCheckedChange={(checked) =>
                            toggleAssignee(profile.id, checked === true)
                          }
                          closeOnClick={false}
                        >
                          {profile.name}
              ...
              <div className='space-y-1 py-4'>
                ...
                <Textarea
                  ...
                  onBlur={() =>
                    startTransition(() =>
                      updateTaskDescription(task.id, projectId, description),
                    )
                  }
              ...
              <div className='space-y-2 py-4'>
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    startTransition(() =>
                      createSubtask(projectId, task.id, subtaskTitle.trim()),
                    );
                    setSubtaskTitle('');
                  }}
                >
              ...
              <div className='space-y-3 py-4'>
                ...
                >
                  ...
                  <Textarea
                    name='body'
                    placeholder='Add a comment or drop files…'
                    className='min-h-16'
                    required
                  />
                  <Button
